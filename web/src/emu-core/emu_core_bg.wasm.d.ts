...
export const wasmemu_dump_state: (a: number) => [number, number];
...
export const emu_power_on: (a: number) => void;
...
export const emu_send_file: (a: number, b: number, c: number) => number;
